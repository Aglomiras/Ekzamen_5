...
import org.example.Agents.AgentBuyer;
import org.example.Agents.AgentSeller;
...
public class JadeStarter {
    public static void main(String[] args) {
        Map<String, Class<?>> agents = Map.of(
                "AgentBuyer", AgentBuyer.class,
                "AgentSeller1", AgentSeller.class,
                "AgentSeller2", AgentSeller.class,
                "AgentSeller3", AgentSeller.class
        );
